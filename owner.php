          ...
          <div class="bank_info">
            ...
            <div class="form-group">
              ...
              <input
                ...
                value="<?= isset($_SESSION['info']['bankName']) ? $_SESSION['info']['bankName'] : '' ?>"
              />
            </div>
            <div class="form-group">
              ...
              <input
                ...
                value="<?= isset($_SESSION['info']['bankBranch']) ? $_SESSION['info']['bankBranch'] : '' ?>"
              />
            </div>
            <div class="form-group">
              ...
              <input
                ...
                value="<?= isset($_SESSION['info']['account']) ? $_SESSION['info']['account'] : '' ?>"
              />
            </div>
          </div>
          <input type="hidden" value="owner" name="clientType" />
